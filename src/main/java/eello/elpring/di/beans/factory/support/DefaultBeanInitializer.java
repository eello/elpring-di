...
import eello.elpring.di.beans.factory.LegacyBeanFactory;
...
public class DefaultBeanInitializer implements BeanInitializer {
	...
	private LegacyBeanFactory beanFactory;
	...
	public DefaultBeanInitializer(LegacyBeanFactory beanFactory, ClassPathBeanDefinitionScanner bdScanner) {
